...
const reports = [
  ...
  { key: "allocation", name: "Project Allocation Report" },
...
export default function Reports() {
  ...
  const build = () => {
    ...
    return rows.map((r) => ({
      EmployeeCode: r.employeeCode, Name: r.name, BusinessUnit: r.businessUnit, Department: r.department, Band: r.band,
      ...
      TimesheetHours: r.timesheetHours, Availability: r.availabilityStatus, AvailableDate: r.availableDate,
    }));
  };
